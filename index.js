// 1. Сохранение информации о супергероях в переменную
let json = JSON.parse(`[{
    "name": "Бетмен",
    "universe": "DC Comics",
    "alterego": "Брюс Уэйн",
...
function createStarRating() {
    ...
    // Создание 5 звездочек рейтинга
    for (let i = 1; i <= 5; i++) {
        let star = document.createElement('span');
        star.classList.add('star');
        star.textContent = '★'; 
        // Добавление события для интерактивного рейтинга
        star.addEventListener('mouseover', function() {
            fillStars(ratingDiv, i);
        });

        star.addEventListener('mouseout', function() {
            fillStars(ratingDiv, 0);
        });

        star.addEventListener('click', function() {
            ratingDiv.setAttribute('data-rating', i); // Сохранение рейтинга
            fillStars(ratingDiv, i);
        });
...
// Функция для заполнения звездочек
function fillStars(ratingDiv, count) {
...
function createHeroCard(hero) {
    ...
    let alterego = document.createElement('p');
    ...
    let friends = document.createElement('p');
...
// Вызов функции для рендеринга героев
renderHeroes();
